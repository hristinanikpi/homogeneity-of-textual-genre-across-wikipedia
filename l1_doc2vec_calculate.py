...
model_nodes_1 = func.Doc2Vec(nodes_1, vector_size=100, min_count=2, epochs=500)
...
func.pickle.dump(scores_nodes_1, open('results/l1_doc2vec_nodes.pkl', 'wb'))

words_1 = list(func.tagged_documents(df_1['Words']))
model_words_1 = func.Doc2Vec(words_1, vector_size=500, min_count=2, epochs=500)
...
func.pickle.dump(scores_words_1, open('results/l1_doc2vec_words.pkl', 'wb'))

nodes_with_words_1 = list(func.tagged_documents(df_1['Nodes with words']))
model_nodes_with_words_1 = func.Doc2Vec(nodes_with_words_1, vector_size=500, min_count=2, epochs=500)
...
func.pickle.dump(scores_nodes_with_words_1, open('results/l1_doc2vec_nodes_with_words.pkl', 'wb'))

parts_of_speech_1 = list(func.tagged_documents(df_1['Parts of speech']))
model_parts_of_speech_1 = func.Doc2Vec(parts_of_speech_1, vector_size=100, min_count=2, epochs=500)
...
func.pickle.dump(scores_parts_of_speech_1, open('results/l1_doc2vec_parts_of_speech.pkl', 'wb'))
