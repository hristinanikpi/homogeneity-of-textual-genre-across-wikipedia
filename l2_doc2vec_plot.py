...
func.plt.savefig('figures/l2_doc2vec_nodes.png')
func.plt.show()
...
func.plt.savefig('figures/l2_doc2vec_nodes_with_words.png')
func.plt.show()
...
func.plt.savefig('figures/l2_doc2vec_words.png')
func.plt.show()
...
func.plt.savefig('figures/l2_doc2vec_parts_of_speech.png')
func.plt.show()
