...
fig.suptitle('TfIdf Nodes Similarities on Level 2')
...
func.plt.savefig('figures_wsw/l2_tfidf_nodes.png')
func.plt.show()

fig, (ax1, ax2) = func.plt.subplots(1, 2, figsize=(42, 20), constrained_layout = True)
fig.suptitle('TfIdf Nodes with Words Similarities on Level 2')
...
func.plt.savefig('figures_wsw/l2_tfidf_nodes_with_words.png')
func.plt.show()

fig, (ax1, ax2) = func.plt.subplots(1, 2, figsize=(42, 20), constrained_layout = True)
fig.suptitle('TfIdf Words Similarities on Level 2')
...
func.plt.savefig('figures_wsw/l2_tfidf_words.png')
func.plt.show()

fig, (ax1, ax2) = func.plt.subplots(1, 2, figsize=(42, 20), constrained_layout = True)
fig.suptitle('TfIdf Parts of Speech Similarities on Level 2')
...
func.plt.savefig('figures_wsw/l2_tfidf_parts_of_speech.png')
func.plt.show()
