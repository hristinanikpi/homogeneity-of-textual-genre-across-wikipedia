...
func.pickle.dump(scores_nodes_2, open('results/l2_doc2vec_nodes.pkl', 'wb'))
...
func.pickle.dump(scores_nodes_with_words_2, open('results/l2_doc2vec_nodes_with_words.pkl', 'wb'))
...
func.pickle.dump(scores_words_2, open('results/l2_doc2vec_words.pkl', 'wb'))
...
func.pickle.dump(scores_parts_of_speech_2, open('results/l2_doc2vec_parts_of_speech.pkl', 'wb'))
