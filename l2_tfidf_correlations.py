...
scores_nodes_2 = func.pickle.load(open('results_wsw/l2_tfidf_nodes.pkl', 'rb'))
scores_nodes_with_words_2 = func.pickle.load(open('results_wsw/l2_tfidf_nodes_with_words.pkl', 'rb'))
scores_words_2 = func.pickle.load(open('results_wsw/l2_tfidf_words.pkl', 'rb'))
scores_parts_of_speech_2 = func.pickle.load(open('results_wsw/l2_tfidf_parts_of_speech.pkl', 'rb'))
...
text = 'correlation: ' + str(x.correlation) + '\n' + 'pvalue: ' + str(x.pvalue)
ax4.text(0.1, 0.6, text)
fig.suptitle('Correlations between Node2Vec and TfIdf similarities on Level 2')
ax1.set_title('Node2Vec and TfIdf (nodes)')
ax2.set_title('Node2Vec and TfIdf (nodes with words)')
ax3.set_title('Node2Vec and TfIdf (words)')
ax4.set_title('Node2Vec and TfIdf (parts_of_speech)')
func.plt.savefig('figures_wsw/l2_tfidf_correlations_part1.png')
func.plt.show()
...
text = 'correlation: ' + str(x.correlation) + '\n' + 'pvalue: ' + str(x.pvalue)
ax4.text(0.6, 0.05, text)
fig.suptitle('Correlations between Simrank and TfIdf similarities on Level 2')
ax1.set_title('Simrank and TfIdf (nodes)')
ax2.set_title('Simrank and TfIdf (nodes with words)')
ax3.set_title('Simrank and TfIdf (words)')
ax4.set_title('Simrank and TfIdf (parts_of_speech)')
func.plt.savefig('figures_wsw/l2_tfidf_correlations_part2.png')
func.plt.show()
...
text = 'correlation: ' + str(x.correlation) + '\n' + 'pvalue: ' + str(x.pvalue)
ax4.text(0.002, 0.6, text)
fig.suptitle('Correlations between Panther and TfIdf similarities on Level 2')
ax1.set_title('Panther and TfIdf (nodes)')
ax2.set_title('Panther and TfIdf (nodes with words)')
ax3.set_title('Panther and TfIdf (words)')
ax4.set_title('Panther and TfIdf (parts_of_speech)')
func.plt.savefig('figures_wsw/l2_tfidf_correlations_part3.png')
func.plt.show()
