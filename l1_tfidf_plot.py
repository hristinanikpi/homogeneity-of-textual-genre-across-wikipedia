...
scores_nodes_1 = func.pickle.load(open('results_wsw/l1_tfidf_nodes.pkl', 'rb'))
scores_nodes_with_words_1 = func.pickle.load(open('results_wsw/l1_tfidf_nodes_with_words.pkl', 'rb'))
scores_words_1 = func.pickle.load(open('results_wsw/l1_tfidf_words.pkl', 'rb'))
scores_parts_of_speech_1 = func.pickle.load(open('results_wsw/l1_tfidf_parts_of_speech.pkl', 'rb'))

fig, ((ax1, ax2), (ax3, ax4)) = func.plt.subplots(2, 2, figsize=(12, 10), constrained_layout = True)
fig.suptitle('TfIdf Similarities on Level 1 (part 1)')
...
ax1.set_title('TfIdf Nodes Similarity Matrix')
ax2.set_title('TfIdf Nodes with Words Similarity Matrix')
func.plt.savefig('figures_wsw/l1_tfidf_part1.png')
func.plt.show()

fig, ((ax1, ax2), (ax3, ax4)) = func.plt.subplots(2, 2, figsize=(12, 10), constrained_layout = True)
fig.suptitle('TfIdf Similarities on Level 1 (part 2)')
...
ax1.set_title('TfIdf Words Similarity Matrix')
ax2.set_title('TfIdf Parts of Speech Similarity Matrix')
func.plt.savefig('figures_wsw/l1_tfidf_part2.png')
func.plt.show()
