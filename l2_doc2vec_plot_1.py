...
func.plt.savefig('figures_1/l2_doc2vec_nodes.png')
func.plt.show()
...
func.plt.savefig('figures_1/l2_doc2vec_nodes_with_words.png')
func.plt.show()
...
func.plt.savefig('figures_1/l2_doc2vec_words.png')
func.plt.show()
