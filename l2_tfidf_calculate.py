...
func.pickle.dump(scores_tfidf_nodes, open('results_wsw/l2_tfidf_nodes.pkl', 'wb'))
...
func.pickle.dump(scores_tfidf_nodes_with_words, open('results_wsw/l2_tfidf_nodes_with_words.pkl', 'wb'))
...
func.pickle.dump(scores_tfidf_words, open('results_wsw/l2_tfidf_words.pkl', 'wb'))
...
func.pickle.dump(scores_tfidf_parts_of_speech, open('results_wsw/l2_tfidf_parts_of_speech.pkl', 'wb'))
