...
func.pickle.dump(scores_nodes_1, open('results_wsw/l1_doc2vec_nodes.pkl', 'wb'))
...
func.pickle.dump(scores_words_1, open('results_wsw/l1_doc2vec_words.pkl', 'wb'))
...
func.pickle.dump(scores_nodes_with_words_1, open('results_wsw/l1_doc2vec_nodes_with_words.pkl', 'wb'))
...
func.pickle.dump(scores_parts_of_speech_1, open('results_wsw/l1_doc2vec_parts_of_speech.pkl', 'wb'))