...
func.plt.title('TF-IDF PCA scatter plot for nodes on Level 1')
func.plt.savefig('figures_wsw/l1_tfidf_pca_nodes.png')
func.plt.show()
...
func.plt.xlabel('PCA Component 1')
func.plt.ylabel('PCA Component 2')
func.plt.title('TF-IDF PCA scatter plot for nodes with words on Level 1')
func.plt.savefig('figures_wsw/l1_tfidf_pca_nodes_with_words.png')
func.plt.show()
...
func.plt.xlabel('PCA Component 1')
func.plt.ylabel('PCA Component 2')
func.plt.title('TF-IDF PCA scatter plot for words on Level 1')
func.plt.savefig('figures_wsw/l1_tfidf_pca_words.png')
func.plt.show()
...
func.plt.xlabel('PCA Component 1')
func.plt.ylabel('PCA Component 2')
func.plt.title('TF-IDF PCA scatter plot for parts of speech on Level 1')
func.plt.savefig('figures_wsw/l1_tfidf_pca_parts_of_speech.png')
func.plt.show()
