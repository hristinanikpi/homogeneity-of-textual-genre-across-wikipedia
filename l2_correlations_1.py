...
scores_nodes_2 = func.pickle.load(open('results_1/l2_doc2vec_nodes.pkl', 'rb'))
scores_nodes_with_words_2 = func.pickle.load(open('results_1/l2_doc2vec_nodes_with_words.pkl', 'rb'))
scores_words_2 = func.pickle.load(open('results_1/l2_doc2vec_words.pkl', 'rb'))
scores_parts_of_speech_2 = func.pickle.load(open('results_1/l2_doc2vec_parts_of_speech.pkl', 'rb'))
...
func.plt.savefig('figures_1/l2_correlations_part1.png')
func.plt.show()
...
func.plt.savefig('figures_1/l2_correlations_part2.png')
func.plt.show()
...
func.plt.savefig('figures_1/l2_correlations_part3.png')
func.plt.show()
