...
scores_nodes_1 = func.pickle.load(open('results_wsw/l1_doc2vec_nodes.pkl', 'rb'))
scores_nodes_with_words_1 = func.pickle.load(open('results_wsw/l1_doc2vec_nodes_with_words.pkl', 'rb'))
scores_words_1 = func.pickle.load(open('results_wsw/l1_doc2vec_words.pkl', 'rb'))
scores_parts_of_speech_1 = func.pickle.load(open('results_wsw/l1_doc2vec_parts_of_speech.pkl', 'rb'))
...
func.plt.savefig('figures_wsw/l1_correlations_part1.png')
func.plt.show()
...
func.plt.savefig('figures_wsw/l1_correlations_part2.png')
func.plt.show()
...
func.plt.savefig('figures_wsw/l1_correlations_part3.png')
func.plt.show()
