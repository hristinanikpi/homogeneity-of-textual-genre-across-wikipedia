...
model_nodes_2 = func.Doc2Vec(nodes_2, vector_size=100, min_count=2, epochs=500)
...
func.pickle.dump(scores_nodes_2, open('results_wsw/l2_doc2vec_nodes.pkl', 'wb'))

nodes_with_words_2 = list(func.tagged_documents(df_2['Nodes with words']))
model_nodes_with_words_2 = func.Doc2Vec(nodes_with_words_2, vector_size=500, min_count=2, epochs=500)
...
func.pickle.dump(scores_nodes_with_words_2, open('results_wsw/l2_doc2vec_nodes_with_words.pkl', 'wb'))

words_2 = list(func.tagged_documents(df_2['Words']))
model_words_2 = func.Doc2Vec(words_2, vector_size=500, min_count=2, epochs=500)
...
func.pickle.dump(scores_words_2, open('results_wsw/l2_doc2vec_words.pkl', 'wb'))

parts_of_speech_2 = list(func.tagged_documents(df_2['Parts of speech']))
model_parts_of_speech_2 = func.Doc2Vec(parts_of_speech_2, vector_size=100, min_count=2, epochs=500)
...
func.pickle.dump(scores_parts_of_speech_2, open('results_wsw/l2_doc2vec_parts_of_speech.pkl', 'wb'))
